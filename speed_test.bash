...
#Python 2
echo "Test Python2 $test_py2"
cat $lines_file | python elasticImporter.py -c example.cfg --no_source --threads 2 --no_all --bulk 5000 2> $test_py2
speed_py2=$(tail -1 $test_py2 | awk '{print $(NF-1)}')
echo "Python2: $speed_py2"
#Python 3
echo "Test Python3 $test_py3"
cat $lines_file | python3 elasticImporter.py -c example.cfg --no_source --threads 2 --no_all --bulk 5000 2> $test_py3
speed_py3=$(tail -1 $test_py3 | awk '{print $(NF-1)}')
echo "Python3: $speed_py3"
#PyPy
echo "Test PyPy $test_pypy"
cat $lines_file | pypy elasticImporter.py -c example.cfg --no_source  --threads 2 --no_all --bulk 5000 2> $test_pypy
